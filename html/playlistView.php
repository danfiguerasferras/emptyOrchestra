            ...
            <div id="itemList">
                ...
                ?>
                    <div id="song_information_<?php echo $song->id_song; ?>" itemNumber="<?php echo $song->id_song;?> " class="listItem">
                        <img src="../images/play-button.png" class="play_button" id="play_button_<?php echo $song->id_song; ?>" songName="<?php echo $song->file_name; ?>" itemNumber="<?php echo $song->id_song; ?>">
